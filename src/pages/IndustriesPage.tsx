                    ...
                    <div className="pt-4 border-t border-slate-200">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {industry.products.map((prod, i) => {
                          const ProdIcon = productIcons[prod] || FlameIcon;
                          return (
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded-xl border border-slate-200">
                  ...
                  <ul className="text-sm text-slate-600 space-y-2">
                    ...
                    <li className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /> Estate management portal access</li>
                    <li className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /> Volume discounts for associations</li>
                  </ul>
                </div>
                ...
                <div className="p-4 bg-white rounded-xl border border-slate-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-slate-900 font-bold">Corporate Businesses</h3>
                  </div>
                  <ul className="text-sm text-slate-600 space-y-2">
                    <li className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /> Scheduled automated reordering</li>
                    <li className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /> Priority dispatch windows</li>
                    <li className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /> Consolidated monthly invoicing</li>
                    <li className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /> Dedicated account manager</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden bg-slate-900">
              <div className="aspect-[4/3] bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center relative">
                ...
                <div className="relative z-10 text-center p-8">
                  ...
                  <p className="text-slate-500 mt-2">Home & Corporate Delivery Corridors</p>
                  <div className="mt-8 grid grid-cols-2 gap-4 text-center">
                    <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                      <p className="text-3xl font-black text-amber-400">2-4hr</p>
                      <p className="text-xs text-slate-500">Standard Delivery</p>
                    </div>
                    <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                      <p className="text-3xl font-black text-amber-400">1hr</p>
                      <p className="text-xs text-slate-500">Emergency Response</p>
                    </div>
                    <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                      <p className="text-3xl font-black text-amber-400">3</p>
                      <p className="text-xs text-slate-500">Dispatch Hubs</p>
                    </div>
                    <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                      <p className="text-3xl font-black text-amber-400">99.9%</p>
      ...
      <section className="py-20 lg:py-28 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Your Industry. Your Energy Partner.
          </h2>
          <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-8">
            Join industry leaders across Lagos who trust SUN LITE LTD for reliable, compliant, and cost-effective petroleum supply.
          </p>
