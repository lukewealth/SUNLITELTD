...
export const Hero: React.FC<HeroProps> = ({ onRequestSupplyClick }) => {
  return (
    ...
    >
      {/* Cinematic Hero Image from Refined Refinery Reference */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Apple-grade clean darkening gradient overlays */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-7">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-slate-900/85 border border-amber-400/40 backdrop-blur-md shadow-sm">
              ...
              <span className="hidden sm:inline-block text-[11px] font-mono-code text-slate-300">
                RC {COMPANY_INFO.rcNumber}
              </span>
            </div>

            {/* Display Headline (Referencing landing page.png editorial style) */}
            <div className="space-y-3">
              <h1 className="font-display text-4xl sm:text-6xl xl:text-7xl font-black text-white tracking-tight leading-[1.05]">
                Meeting Energy Demand In A Dependable Way.
              </h1>
              <p className="text-xl sm:text-2xl font-medium text-amber-400">
            ...
            {/* 3 Pill Badges (Directly echoing landing page.png pill tags) */}
          ...
          {/* Right Visual Card Featuring Actual Branded Tanker Truck */}
